...
input_path = '../../dataset/evaluation/audio/'
output='../feat/evaluation/audio/'
...
input_path = '../../dataset/evaluation/background/'
output='../feat/evaluation/background/'
...
input_path = '../../dataset/evaluation/foreground/'
output='../feat/evaluation/foreground/'
