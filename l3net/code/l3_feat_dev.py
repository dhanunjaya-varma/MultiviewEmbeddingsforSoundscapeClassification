...
input_path = '../../dataset/development/audio/'
output='../feat/development/audio/'
...
input_path = '../../dataset/development/background/'
output='../feat/development/background/'
...
input_path = '../../dataset/development/foreground/'
output='../feat/development/foreground/'
